                        ...
                        <div className="absolute bottom-0 left-0 right-0 z-30 p-6 md:p-10 lg:p-14">
                            <div className="grid grid-cols-12 gap-4 items-end">
                                ...
                                <div className="col-span-12 lg:col-span-4 lg:pb-4">
                                    ...
                                    <a href="#" className="inline-flex items-center gap-2 bg-primary rounded-full px-5 py-2.5 text-black font-medium text-sm sm:text-base group hover:gap-3 transition-all">
                                            Derneğe Katıl
